...
public class WandCreateAreaCommand {

    public WandCreateAreaCommand(CommandDispatcher<ServerCommandSource> dispatcher) {
                    ...
                    CommandManager.literal(a)
                            .then(
                                    CommandManager.literal("wand")
                                                    .then(
                                                            CommandManager.literal("createarea")
                                                                    .then(
                                                                            CommandManager.argument("region", StringArgumentType.word())
                                                                                    .suggests(
                                                                                            (context, builder) -> CommandSource.suggestMatching(ConfigGetters.regionNames, builder)
                                                                                    )
                                                                                    .then(
