...
public class RegionPermissions {
    ...
    public RegionPermissions (String enterMessage, List<String> enterPermissions, String enterTeleportLocation, String leaveMessage, List<String> leavePermissions, String leaveTeleportLocation) {
